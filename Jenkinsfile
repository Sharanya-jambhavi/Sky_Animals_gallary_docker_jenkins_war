    ...
    stages {
        ...
        stage('Docker Tag the Image') {
            steps {
                ...
                sh 'sudo docker tag snapchat-sak-cicd-docker sky1912/snapchat-sak-cicd-docker:latest'
            }
            post {
                success {
        ...
        stage('Docker Push the Image') {
            steps {
                ...
                sh 'sudo docker push sky1912/snapchat-sak-cicd-docker:latest'
            }
            post {
                success {
        ...
        stage('Cleanup Local Docker Images') {
            steps {
                ...
                sh '''
                    sudo docker rmi sky1912/snapchat-sak-cicd-docker:latest
                    ...
                    if (containerExists) {
                        ...
                        if (userChoice == 'Yes') {
                            ...
                            sh '''
                                ...
                                sudo docker run -d -p 8084:8080 --name snapchat-container sky1912/snapchat-sak-cicd-docker:latest
                            '''
                        } else {
                        ...
                        sh 'sudo docker run -d -p 8084:8080 --name snapchat-container sky1912/snapchat-sak-cicd-docker:latest'
                    }
                }
            }
        }
